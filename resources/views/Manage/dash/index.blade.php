...
<header class="navbar-wrapper">
  <div class="navbar navbar-fixed-top">
    <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">我的博客</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
  ...
  <div class="menu_dropdown bk_2">
            ...
            @if(isset($menu['_child']))
              @foreach($menu['_child'] as $value)
                @if(isset($value['_child']))
                  <li>
                    <dt><i class="Hui-iconfont">{{$value['icon']}}</i> {{$value['name']}}<i class="Hui-iconfont">&#xe6d5;</i></dt>
                    <ul>
                  @foreach($value['_child'] as $val)
                      <li><i class="Hui-iconfont">{{$val['icon']}}</i><a data-href="{{$val['route']}}" data-title="{{$val['name']}}" href="javascript:void(0)">{{$val['name']}}</a></li>
                  @endforeach
                    </ul>
                  </li>
                @else
                  <li><a data-href="{{$value['route']}}" data-title="{{$value['name']}}" href="javascript:void(0)"><i class="Hui-iconfont">{{$value['icon']}}</i>{{$value['name']}}</a></li>
                @endif
   ...
   {{-- <dl id="menu-tongji">
      ...
      <dd>
        <ul>
          ...
          <li>
            <dt><i class="Hui-iconfont">&#xe61a;</i> 系统统计<i class="Hui-iconfont">&#xe6d5;</i></dt>
              <ul>
                <li><a data-href="charts-1.html" data-title="折线图" href="javascript:void(0)">折线图</a></li>
              </ul>
          </li>
   ...
   <dl id="menu-tongji">
    ...
    <dl id="menu-system">
      ...
      <dd>
        <ul>
          <li><a data-href="system/menu/0/1" data-title="菜单管理" href="javascript:void(0)">菜单管理</a></li>--}}
